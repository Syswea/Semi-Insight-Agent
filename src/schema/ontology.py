...
class RelationType(str, Enum):
    ...
    REVENUE = "REVENUE"  # (Org|Segment)-[:REVENUE]->(Metric)
...
ALLOWED_RELATIONS = [
    ...
    (EntityLabel.ORGANIZATION, RelationType.REVENUE, EntityLabel.METRIC),
    (EntityLabel.INDUSTRY_SEGMENT, RelationType.REVENUE, EntityLabel.METRIC),
]
